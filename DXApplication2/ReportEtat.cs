...
namespace DXApplication2
{
    public partial class ReportEtat : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void InitData(string n_marche, string objet, string apo,string Attribute , int delai_jour, string montant, DateTime date_op, DateTime dateportail, List<class_reportData> reportdata)
        {
